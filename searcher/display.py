...
from searcher import markup, debug
...
class Display(object):
    ...
    def add_string(self, s, pos_y=0, pos_x=0, style=None, n=-1):
        self.addnstr(pos_y, pos_x, s, n if n >=
                     0 else self.WIDTH - pos_x, style)
    ...
    def addnstr(self, y, x, s, n, style):
        ...
        bytes_count_to_display = screen_length_to_bytes_count(
            s, n, self.encoding)
...
if __name__ == "__main__":
    ...
    display.add_aligned_string(u" foo bar baz qux ",
                               ...
                               style=display.attrs_to_style(
                                   ("bold", "white", "on_default")),
                               fill=True, fill_char='-')
